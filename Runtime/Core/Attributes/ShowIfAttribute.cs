...
namespace Gummi
{
    ...
    public class ShowIfAttribute : VisibleBaseAttribute
    {
        public ShowIfAttribute(string target) : base(target, toggleVisibility: true) { }

        public ShowIfAttribute(string target, object benchmark) : base(target, benchmark, toggleVisibility: true) { }
